...
const LandingPage = () => {
  return (
    <div className="bg-gray-900 text-white min-h-screen">
      {/* Hero Section */}
      <header className="bg-gradient-to-r from-[#672ACC] to-[#4737CA] py-20 px-8 text-center">
      ...
      <section className="py-16 px-8 bg-gray-800 ">
        ...
        <p className="text-gray-100 text-center">Find answer to Common questions about service, features,and more.</p>
  ...
  <div className="container mx-auto px-6">
    ...
    {/* Copyright Section */}
    <div className=" shadow-lgtext-center mt-12 mb-8 border border-gray-700  rounded-3xl h-[80px] w-[70%] flex items-center justify-center mx-auto ">
